...
android {
    namespace = "com.luis.hsbctest"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.luis.hsbctest"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        testInstrumentationRunner =
            "com.luis.hsbctest.ui.temperature.presentation.main.CustomTestRunner"
        vectorDrawables {
...
dependencies {
    ...
    //Test Instrumental (Android) (UI Testing)
